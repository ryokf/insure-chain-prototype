class MockData {
  ...
  static const List<Map<String, dynamic>> tiers = [
    {
      ...
      'color': 'blue',
      'features': [
        'Perlindungan perjalanan singkat',
        'Batas bantuan 15 juta',
        'Respon 48 jam',
      ],
    },
    {
      ...
      'color': 'blue',
      'features': [
        'Perlindungan liburan antar kota',
        'Batas bantuan 30 juta',
        'Respon 24 jam',
      ],
    },
    {
      ...
      'color': 'purple',
      'features': [
        'Perlindungan komprehensif bulanan',
  ...
  static const List<Map<String, dynamic>> claimHistory = [
    ...
    },
    {
      ...
      'type': 'Goresan Bodi',
      'result': 'Ditolak',
      'rejectedAtStep': 'Verifikasi Pathfinder',
      'amount': '3,200,000',
      'date': '5 Jan 2026',
    },
    {
